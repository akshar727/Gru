...
def get_economy_embed(prefix):
    economy_embed = discord.Embed(title="Help Commands",
                                  description='All the **Economy** commands in the bot. (Page 1)', color=0x00ff00)
    economy_embed.add_field(name=f'{prefix}bankrob <user>', value='''Allows you to rob a user's bank''', inline=False)
    economy_embed.add_field(name=f'{prefix}work <job name>', value='Allows you to get a job a Gru enterprises™!',
                            inline=False)
    ...
    economy_embed.add_field(name=f'{prefix}crateinfo', value='Allows you to view the cash ranges of all the crates.',
                            inline=False)
    ...
    economy_embed.add_field(name=f'{prefix}balance [user] / {prefix}bal [user]',
                            value='Allows you to see the balance of you and others.', inline=False)
    economy_embed.set_footer(text="Arguments that are surrounded in [] are optional. Page 1/3")

    economy_embed_2 = discord.Embed(title="Help Commands",
                                    description='All the **Economy** commands in the bot. (Page 2)', color=0x00ff00)
    ...
    economy_embed_2.add_field(name=f'{prefix}withdraw / {prefix}with', value='To withdraw money from bank',
                              inline=False)
    ...
    economy_embed_3 = discord.Embed(title="Help Commands",
                                    description='All the **Economy** commands in the bot. (Page 3)', color=0x00ff00)
    economy_embed_3.add_field(name=f'{prefix}sell [amount] <item>', value='Allows you to sell items you get.',
                              inline=False)
    economy_embed_3.add_field(name=f'{prefix}inventory / {prefix}inv', value='Shows you inventory', inline=False)
    economy_embed_3.add_field(name=f'{prefix}leaderboard [amount] / {prefix}lb [amount]',
                              value='''Allows you to see the richest people in the bot!The types are `all` to see all 
                              users in the leaderboard and `server` to see only users in this server.''',
                              inline=False)
    economy_embed_3.add_field(name=f'{prefix}daily / {prefix}weekly', value='''Allows you to earn some Minions™️!''',
                              inline=False)
    economy_embed_3.add_field(name=f'{prefix}hunt', value="Allows you to hunt for animals and sell them in the shop!",
                              inline=False)
    economy_embed_3.add_field(name=f'{prefix}fish', value="Allows you to fish for animals and sell them in the shop!",
                              inline=False)
    economy_embed_3.add_field(name=f'{prefix}work resign', value="Allows you to resign from your current job!",
                              inline=False)
...
def get_moderation_embeds(prefix):
    page1 = discord.Embed(title="Help Commands", description='All the **Moderation** commands in the bot. (Page 1)',
                          color=0x00ff00)
    # page1.add_field(name='gcreate <amount of time> <prize>',
    #                 value='Allows you to create a giveaway. Requires Manage Guild')
    # page1.add_field(name='reroll <giveaway message id>',
    #                 value='Allows you reroll a giveaway. Can also be used to forcefully end a giveaway. Requires '
    #                       'Manage Guild')
    # page1.add_field(name='config', value='Allows you to change server configurations. Requires Manage Guild')
    page1.add_field(name=f'{prefix}takerole <user> <role> ',
                    value="Allows you to take a role away from someone. Requires Manage Roles.")
    page1.add_field(name=f'{prefix}reactrole <emoji> <role> <message> ',
                    value="Allows you to create reactions roles. Requires Manage Roles.")
    page1.add_field(name=f'{prefix}scn / {prefix}set_channel_name <original channel name> <new channel name> ',
                    value="Allows you to change a channel's name. Requires Manage Channels.")
    page1.add_field(name=f'{prefix}giverole <user> <role> ',
                    value="Allows you to give a role to someone.**NOTE** You can only give roles up to your highest "
                          "rank. Requires Manage Roles.")
    page1.add_field(name=f'{prefix}prefix <prefix> ',
                    value="Allows you to change the prefix of the bot in this server(**Owner only**)")
    page1.set_footer(text="Arguments that are surrounded in [] are optional. Page 1/2")

    page2 = discord.Embed(title="Help Commands", description='All the **Moderation** commands in the bot. (Page 2)',
                          color=0x00ff00)
    ...
    page2.add_field(name='setup_tickets',
                    value="Allows you to create a button for users to create tickets. Requires Manage Guild.")
...
def get_music_embeds(prefix):
    page1 = discord.Embed(title="Help Commands", description='All the **Music** commands in the bot. (Page 1)',
                          color=0x00ff00)
    ...
    page1.add_field(name=f"{prefix}disconnect / {prefix}dc", value="Disconnects the bot from the voice channel.",
                    inline=False)
    ...
    page2 = discord.Embed(title="Help Commands", description='All the **Music** commands in the bot. (Page 2)',
                          color=0x00ff00)
    page2.add_field(name=f"{prefix}queue / {prefix}q", value="Shows the queue for music.", inline=False)
    page2.add_field(name=f"{prefix}np / {prefix}nowplaying", value="Shows the currently playing song and details.",
                    inline=False)
...
def get_fun_embeds(prefix):
    page1 = discord.Embed(title="Help Commands", description='All the **Fun** commands in the bot. (Page 1)',
                          color=0x00ff00)
    page1.add_field(name=f'{prefix}showpic <query> / {prefix}show <query>',
                    value='Allows you to search a image on the web with a query', inline=False)
    page1.add_field(name=f'{prefix}youtube <query>', value='Allows you to search a video on youtube with a query',
                    inline=False)
    ...
    page1.add_field(name=f'{prefix}level / {prefix}lvl / {prefix}rank',
                    value='''Tells you your level with how much xp you have in that level!''', inline=False)
    ...
    page3 = discord.Embed(title="Help Commands", description='All the **Fun** commands in the bot. (Page 3)',
                          color=0x00ff00)
    page3.add_field(name=f'{prefix}trigger <user> / {prefix}trigger <user>', value="Makes a user really triggered...",
                    inline=False)
    page3.add_field(name=f'{prefix}joke', value="Gives you a joke!", inline=False)
    page3.add_field(name=f'{prefix}genderify <name> / {prefix}gender <name>', value="I guess your gender by your name!",
                    inline=False)
    ...
    page4 = discord.Embed(title="Help Commands", description='All the **Fun** commands in the bot. (Page 4)',
                          color=0x00ff00)
    page4.add_field(name=f'{prefix}members', value='''Allows you to see how many people are in the server!''',
                    inline=False)
    page4.add_field(name=f'{prefix}covid <country> / {prefix}covid19 <country>',
                    value='''Allows you to see the covid statistics of a country!''', inline=False)
    page4.add_field(name=f'{prefix}roles', value='''Allows you to see all roles in the server!''', inline=False)
    page4.add_field(name=f'{prefix}lvllb',
                    value='''Allows you to see all the top users with the highest levels in the server!''',
                    inline=False)
...
def replace_text_between(original_text, delimeterA, delimterB, replacementText):
    try:
        leading_text = original_text.split(delimeterA)[0]
        trailing_text = original_text.split(delimterB)[1]
    except:
        return original_text

    return leading_text + replacementText + trailing_text
