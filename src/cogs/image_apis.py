...
class DropdownImageSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        return await self.message.edit(content="Images generated by **https://craiyon.com**",file=discord.File(image, filename="generatedImage.png"),view=DropdownImageView(self.message,self.images,self.user))
...
class ImageApis(commands.Cog):
    ...
    async def generate(self, ctx,* ,prompt : str):
        ...
        async with aiohttp.request("POST","https://backend.craiyon.com/generate",json={"prompt":prompt}) as resp:
            ...
            return await msg.edit(content="Images generated by **https://craiyon.com**",file=discord.File(image, filename="generatedImage.png"),view=DropdownImageView(msg,images,ctx.author.id))
